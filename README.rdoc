...
- Replace all occurrences of <code>Base::Application</code> with <code>PROJECT::Application</code> (e.g. <code>PrettyCalc::Application</code>) and every occurrence of <code>Module Base</code> with <code>Module PROJECT</code> (e.g. <code>Module PrettyCalc</code>)
...
- Set the correct value of <code>repo_token</code> in <code>.travis.yml</code>
...
- Create an <code>.rspec</code> file with your specific RSpec config, e.g. <code>--color</code>, <code>--fail-fast</code>, and <code>--require spec_helper</code>
