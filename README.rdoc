...
- Replace all occurrences of <code>ProjectManager::Application</code> with <code>PROJECT::Application</code> (e.g. <code>PrettyCalc::Application</code>), every occurrence of <code>module ProjectManager</code> with <code>module PROJECT</code> (e.g. <code>module PrettyCalc</code>), and every occurrence of <code>ProjectManager::</code> with <code>PROJECT::</code> (e.g. <code>PrettyCalc::</code>)
