...
describe 'Listing pages' do
  ...
  it 'displays pages' do
    ...
    expect(page).to have_title 'Pages - Project Manager'
    expect(page).to have_active_navigation_items 'Pages', 'List of Pages'
    expect(page).to have_breadcrumbs 'Project Manager', 'Pages'
  ...
  it 'offers an ATOM feed' do
    ...
    within 'entry:nth-of-type(1)' do
      ...
      within 'content' do
        ...
        expect(page).to have_content '<ol><li><a href="/en">Project Manager</a></li><li><a href="/en/pages/1">Page test navigation title</a></li></ol>'
    ...
    within 'entry:nth-of-type(2)' do
      ...
      within 'content' do
        expect(page).to have_content '<ol><li><a href="/en">Project Manager</a></li><li><a href="/en/pages/1">Page test navigation title</a></li><li><a href="/en/pages/2">Page test navigation title</a></li></ol>'
      end
    end
  end
end