...
RSpec.describe Timetrack, type: :model do
  ...
  #it { should validate_numericality_of(:work_time).is_greater_than_or_equal_to(0).with_message "must be greater than or equal 0" }
  #it { should validate_numericality_of(:bill_time).with_message "is not a number" }
